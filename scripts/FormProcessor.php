...
class FormProcessor
{
    ...
    public function process($form)
    {
        ...
        //die($this->_getErrorResponse("In process before _checkRequiredFields"));
        ...
        //die($this->_getErrorResponse("In process before _formSubmission"));
    ...
    private function _formSubmission($form)
    {
        ...
        //die($this->_getErrorResponse($to.$subject.$message.$headers));
...
STYLES;
    ...
    public function _getErrorResponse($error)
    {
        if (is_array($error)) {
            $errorMsg = '';
